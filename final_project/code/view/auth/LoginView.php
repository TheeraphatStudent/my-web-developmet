...
<body class="flex w-screen h-screen items-center justify-around xl:flex-row flex-col">
    <div class="flex flex-col card gap-10 shadow-primary/40">
        ...
        <form class="space-y-4" id="loginForm" action="#" method="post">

            <div>
                <!-- <label class="text-gray-800 text-sm mb-2 block">ชื่อบัญชี</label> -->
                <div class="relative flex items-center">
                    <input name="username" type="text" requiredd class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-green-600" placeholder="ชื่อผู้ใข้งาน" required />
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="password" id="password" type="password" requiredd class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-green-600 password" placeholder="รหัสผ่าน" required minlength="10" />
