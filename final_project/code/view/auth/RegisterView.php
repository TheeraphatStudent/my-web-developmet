        ...
        <form class="space-y-4" id="registerForm" action="" method="post">
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="email" type="email" requiredd class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-orange-600" placeholder="อีเมล" required />
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input name="username" type="text" requiredd class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-orange-600" placeholder="ชื่อผู้ใช้" required />
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
            ...
            <div>
                ...
                <div class="relative flex items-center">
                    <input minlength="10" name="password" id="password" type="password" requiredd class="w-full text-sm text-gray-800 border border-gray-300 pl-4 pr-10 py-3 rounded-lg outline-orange-600 password" placeholder="รหัสผ่าน" required />
