        ...
        <ol class="flex items-center whitespace-nowrap overflow-hidden">
            ...
            ?>
                <li class="inline-flex items-center">
                    <?php if (!$isLast) : ?>
                        <a class="flex items-center text-white hover:text-dark-primary focus:outline-none focus:text-dark-primary dark:text-neutral-500 dark:hover:text-dark-primary/50 dark:focus:text-dark-primary/50 no-underline text-2xl" href="#">
