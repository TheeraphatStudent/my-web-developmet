...
if (isset($_GET['uniq_id'])) {
    ...
    $student = $std->getStudentByUniqId($uniq_id)['data'];
}
    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900 shadow-md h-[72px]">
        <div class="max-w-screen-lg flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="./" class="flex items-center space-x-3 rtl:space-x-reverse">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Student's / <?php echo ($student['stdid']) ?></span>
            </a>
        </div>
    </nav>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <input
                                ...
                                id="stdid" name="stdid" type="text" placeholder="Student Id" value="<?php echo ($student['stdid']) ?>">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <select required name="prefix" id="prefix" class="shadow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-tl-lg rounded-bl-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <option value="Mr" <?php echo ($student['prefix'] == 'Mr') ? 'selected' : ''; ?>>Mr.</option>
                                <option value="Mrs" <?php echo ($student['prefix'] == 'Mrs') ? 'selected' : ''; ?>>Mrs.</option>
                            </select>
                            <input
                                required
                                ...
                                name="name" id="name" type="text" placeholder="Student name" value="<?php echo ($student['name']) ?>">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <select required name="year" id="year" class="shadow bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                ...
                                <option value="5" <?php echo ($student['year'] == '5') ? 'selected' : '' ?>>5</option>
                                <option value="6" <?php echo ($student['year'] == '6') ? 'selected' : '' ?>>6</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="w-full">
                            ...
                            <div class="flex">
                                <input
                                    required
                                    class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    name="grade" id="grade" type="text" placeholder="Average Grade" value="<?php echo ($student['grade']) ?>">
                            </div>
                        </div>
                        <div class="w-full">
                            ...
                            <div class="flex">
                                <input
                                    required
                                    class="shadow appearance-none border rounded-lg w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    name="birthday" id="birthday" type="date" placeholder="Birthday" value="<?php echo ($student['birth']) ?>">
                            </div>
                        </div>
                    </div>
                </form>
